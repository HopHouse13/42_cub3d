...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   init_err_msgs_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: pab <pab@student.42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/11 16:56:31 by pbret             #+#    #+#             */
/*   Updated: 2025/10/21 22:59:18 by pab              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_err_msgs(t_cub *cub)
{
	...
	cub->err_msg[PSG_NO_KEY_ERR] = "missing map elements";
	...
	cub->err_msg[PSG_READ_PATH_ERR] = "Unable to read texture file";
	...
	//cub->err_msg[PSG_DOOR] = "invalid door"; // bonus
